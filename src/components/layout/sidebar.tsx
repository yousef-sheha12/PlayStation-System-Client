...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { href: "/categories", label: t("sidebar.categories"), icon: Tag },
    { href: "/inventory", label: t("sidebar.inventory"), icon: Box },
    ...
    { href: "/expenses", label: t("sidebar.expenses"), icon: DollarSign },
